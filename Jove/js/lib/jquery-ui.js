...
; (function ($) {
    ...
    function install(el, opts) {
        ...
        var lyr1 = ((!!window.ActiveXObject || "ActiveXObject" in window) || opts.forceIframe)
		? $('<iframe class="blockUI" style="z-index:' + (z++) + ';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="' + opts.iframeSrc + '"></iframe>')
		: $('<div class="blockUI" style="display:none"></div>');
        var lyr2 = $('<div class="blockUI blockOverlay" style="z-index:' + (z++) + ';display:none;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0;background-color: #000000;opacity: 0.1;"></div>');
        ...
        if (opts.theme && full) {
            ...
            s = '<div class="blockUI blockMsg blockPage" style="z-index:' + z + ';display:none;position:fixed">';
            s += '<div class="sk-cube-grid">';
            s += '<div class="sk-cube sk-cube1"></div>';
            s += '<div class="sk-cube sk-cube2"></div>';
            s += '<div class="sk-cube sk-cube3"></div>';
            s += '<div class="sk-cube sk-cube4"></div>';
            s += '<div class="sk-cube sk-cube5"></div>';
            s += '<div class="sk-cube sk-cube6"></div>';
            s += '<div class="sk-cube sk-cube7"></div>';
            s += '<div class="sk-cube sk-cube8"></div>';
            s += '<div class="sk-cube sk-cube9"></div>';
            s += '</div>';
            s += '</div>';
        }
        else {
        ...
        if ((!!window.ActiveXObject || "ActiveXObject" in window) || opts.forceIframe)
        ...
        if (((!!window.ActiveXObject || "ActiveXObject" in window) || opts.forceIframe) && opts.showOverlay)
...
$.widget( "ui.resizable", $.ui.mouse, {
	...
	_mouseDrag: function( event ) {
		...
		if (this._aspectRatio || event.shiftKey || aspectRatioFlag) {
		    data = this._updateRatio(data, event);
		    aspectRatioFlag = false;
		}
	...
	_updateVirtualBoundaries: function( forceAspectRatio ) {
		...
		if (this._aspectRatio || forceAspectRatio || aspectRatioFlag) {
