 ...
 * Licensed under the  license */
    ...
    var gestures = angular.module('ng-sobey-gestures', []);
    ...
    gestures.provider('hammerDefaultOpts', function HammerDefaultOptsProvider() {
        var opts = {};
    ...
    angular.forEach(HGESTURES, function (eventName, directiveName) {
        gestures.directive(directiveName, ['$parse', '$log', '$timeout', 'hammerDefaultOpts', function ($parse, $log, $timeout, hammerDefaultOpts) {
